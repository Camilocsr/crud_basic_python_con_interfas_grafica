...
def barra_menu(root):
    ...
    menu_inicio.add_command(label='eliminar reguistro', command=borrar_tabla) #se agrega
    menu_inicio.add_command(label='Salir del programa.', command=root.destroy)#Se agrega...
